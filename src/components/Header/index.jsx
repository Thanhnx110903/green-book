  ...
  return (
    <>
        ...
        <div>
          <div  className={cx('max-w-[1400px] mx-auto')}>
            ...
            <div class='block lg:hidden'>
              ...
              <Link to='/' className=''>
                <img src='/src/assets/imgs/logo3.png' alt='' className='object-cover' />
              </Link>
              <div className='w-[40%]  hidden lg:flex md:mr-30 lg:mr-1 '>
              ...
              <div className='lg:flex  items-center gap-[16px]  text-[1.4rem] text-[#000000]'>
                ...
                <Link to='/cart' className={cx('flex items-center', 'header-cart')}>
      ...
      <div className={cx('pt-[10px] hidden lg:block', 'bg')}>
        <div className={cx('max-w-[1400px] mx-auto')}>
          <div className={cx('d-flex lg:flex-row flex-col')}>
