    ...
    <div className={cx('mb-[70px]')}>
      ...
      <div className={cx('container-wrap')}>
        <div className={cx('flex flex-col md:flex-row justify-between mt-[40px]')}>
          <div className={cx('w-full md:max-w-[70%] lg:max-w-[75%]')}>
            ...
            {isLoading ? (
              ...
              <div className={cx('  gap-2', 'news-list')}>
                <div className=''>
                  <div align='justify' className='text-justify px-4 md:px-0'>
                    ...
                    <img
                      ...
                      alt=''
                    />
                    <div className={cx('text-justify mt-3')}>{parse(data?.data?.content)}</div>
                  </div>
                </div>
              </div>
            )}
          ...
          <div
            className={cx(
              'w-full md:ml-[15px] md:pl-[15px] md:max-w-[30%] lg:max-w-[25%] mt-10 md:mt-10 px-4 md:px-0',
              'news-left'
            )}
          >
              ...
              <div>
                {dataHotPost?.data?.slice(0, 3)?.map((item) => {
                  return (
                    ...
                    >
                      <img
                        className={cx('w-[100px] h-[65px]')}
                        src={item?.image || '/src/assets/imgs/news-01.webp'}
                        alt=''
                      />
