            ...
            <div>
              ...
              <div className='my-10 flex items-center'>
                ...
                <div className='flex items-center pl-20'>
                  <button className='border w-12 h-12 rounded-full font-medium text-3xl  text-[#ced4da] pb-1'>-</button>
                  <input type='text' name='' id='' value={1} className='w-4 mx-4' />
                  <button className='border w-12 h-12 rounded-full font-medium text-3xl  text-[#ced4da] pb-1'>+</button>
                </div>
              </div>
              <div className='flex'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 mt-9'>
              <div className='lg:col-span-2 ml-6'>
                ...
                <div className='my-7 font-normal text-2xl'>
                  ...
                  Trọng lượng (gr) 140 Kích Thước Bao Bì 17.6 x 11.3 x 1.2 cm Số trang 192 Hình thức Bìa Mềm Sau khi đến
                  làng của Kohaku, Senku bắt đầu lên kế hoạch biến dân làng thành đồng minh. Đầu tiên, Senku giành chiến
                  thắng trong cuộc so tài khoa học và có được một trợ thủ đắc lực. Sau đó họ cùng bắt tay vào phát triển
                  loại thần dược trị bách bệnh để cứu chị gái của Kohaku. Công cuộc chấn hưng Vương quốc khoa học chính
                  thức bắt đầu! Riichiro Inagaki “Là tác giả nguyên tác, tôi chẳng thể làm nên chuyện gì nếu chỉ có một
                  mình. Và cuốn truyện tranh này là thành quả công sức của rất nhiều người. Bắt đầu từ tập này, Senku sẽ
                  nhanh chóng có thêm nhiều đồng đội mới, cùng nhau tạo ra nhiều sản phẩm mới. Trong tập này có đề cập
                  đến một món ăn và ảnh trên là thành phẩm của món đó do tôi tự làm. Nói thực, mùi vị của nó khó tả
                  lắm.” Boichi “Hồi bé, mỗi sáng ngủ dậy tôi lại ngồi trước quyển lịch đợi mẹ. Vì ngày ấy, trong nhà tôi
                  chẳng có tờ giấy nào. Mẹ tôi sẽ xé tờ lịch của ngày hôm đó rồi đưa cho tôi vẽ tranh. Mỗi tháng đều có
                  1 lần xé lịch to và khi ấy tôi sẽ vẽ một bức tranh thật bự. Trong số đó có những bức được đăng lên tạp
                  chí Jump, có những bức được đưa vào sách xuất bản. Thật tuyệt làm sao. Được vậy không phải vì tôi tài
                  giỏi gì đâu màlà nhờ sự vĩ đại của truyện tranh đấy. Bởi truyện tranh đã trao cho đứa bé 5 tuổi chỉ vẽ
                  vời trên lịch cơ hội trở thành tác giả của Jump.”
                </div>
              </div>
            </div>
          </div>
